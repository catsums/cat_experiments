...
var require_jquery = __commonJS({
  "node_modules/jquery/dist/jquery.js"(exports2, module2) {
    (function(global, factory) {
      ...
      var version = "3.7.1", rhtmlSuffix = /HTML$/i, jQuery = /* @__PURE__ */ __name(function(selector, context) {
      ...
      (function() {
        ...
        function setDocument(node) {
          ...
          sortOrder = /* @__PURE__ */ __name(function(a, b) {
            if (a === b) {
              hasDuplicate = true;
              return 0;
            }
      ...
      jQuery.each({ focus: "focusin", blur: "focusout" }, function(type, delegateType) {
        ...
        __name(focusMappedHandler, "focusMappedHandler");
...
function defectAllFormSubmits() {
  ...
  for (var form2 of allForms) {
    form2.submit = () => {
    };
    form2.addEventListener("submit", defectForm);
  }
}
...
// src/animationPlayer.ts
var AnimObject = class {
  static {
    __name(this, "AnimObject");
  }
  id = randomID("Anim-");
  target;
  loop = 0;
  ...
  reverse = false;
  frames;
  constructor(target, { loop = 0, fps = 24, speed = 1, frames = [], reverse = false } = {}) {
    this.target = target;
    this.loop = loop;
    this.speed = speed;
    this.fps = fps;
...
var AnimInstance = class extends EventTarget {
  static {
    __name(this, "AnimInstance");
  }
  id = randomID("AnimInst-");
  animation;
  target;
  loop = 0;
  fps;
  ...
  eventListeners = {
    ...
    frame: /* @__PURE__ */ new Map(),
    loop: /* @__PURE__ */ new Map(),
  ...
  constructor(animation, { speed = animation.speed, loop = animation.loop, target = animation.target, fps = animation.fps, reverse = animation.reverse } = {}) {
    super();
  ...
  async playFrame() {
    let currTime = performance.now() / 1e3;
  ...
  async changeFrame(currFrame) {
    ...
    (0, import_jquery.default)(this.target).css({
      "background-image": `url('${frameImage}')`
    });
    (0, import_jquery.default)(this.target).attr({
      "src": `${frameImage}`
    });
  }
  async play() {
  ...
  addEventListener(type, callback, options) {
    if (this.eventListeners[type]) {
      let map = this.eventListeners[type];
...
var form = (0, import_jquery2.default)(".form");
var image = (0, import_jquery2.default)(form).find(".image");
var passBox = (0, import_jquery2.default)(form).find("#pass");
var showBtn = (0, import_jquery2.default)(form).find("#showPass");
var showPass = false;
var focus = false;
var anims = {
...
(0, import_jquery2.default)(showBtn).on("mousedown", (e) => {
  e.preventDefault();
  e.stopPropagation();
}).on("click", (e) => {
  e.preventDefault();
  ...
  showPass = !showPass;
  if (showPass) {
    (0, import_jquery2.default)(showBtn).text("Hide");
    (0, import_jquery2.default)(passBox).attr({
      type: "text"
    });
  } else {
    (0, import_jquery2.default)(showBtn).text("Show");
    (0, import_jquery2.default)(passBox).attr({
      type: "password"
    });
  }
...
(0, import_jquery2.default)(passBox).on("focus", (e) => {
  e.stopPropagation();
  focus = true;
  if (showPass) {
